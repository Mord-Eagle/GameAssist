...
Use this document for durable release boundaries, sequencing, and completion gates. Use the linked GitHub issues for implementation details and acceptance evidence. Issues #60, #64, and #65 are complete. PR #81 remains the single v2.0.0 development line: EffectAssist, HealAssist, AttackAssist, and all six AlmanacAssist systems share that branch; Issue #88 carries the player-casting and retained GM-request workflow now advanced through EffectAssist 2.5.1 with guarded recipient and concentration preflight; Issue #90 consolidates the remaining AlmanacAssist custom-calendar and world-context UX failures after the Issue #89 control checkpoint; Issue #83 adds the shared HealthService foundation; Issue #79 uses that foundation for private concentration-check offers and ConcentrationAssist 0.5.0 adds portable marker defaults plus guided marker controls; Issue #80 adds conservative effect-duration candidates; Issue #77 adds bounded official 2014 Bless cast proposals; Issue #84 adds reviewed 2014 healing through verified HealthService writes; and Issue #87 advances AttackAssist to 1.0.3 with compact direct targeting, executable roll modes, and safe translation of documented optional 2014-sheet defaults. None of this work creates a parallel release branch or authorizes publication.
...
| EffectAssist player-casting workflow | Sandbox verification | [#88](https://github.com/Mord-Eagle/GameAssist/issues/88) | EffectAssist 2.5.1 uses short-lived player-bound choices, a compact caster step followed by recipient count, Bless totals of 1-3 plus Higher Level Casting totals of 4-11, consistent `(GA)` owned rows, retained GM requests, direct GM controls, visible stale-button recovery, named unlinked-recipient guidance, and concentration-marker preflight before target writes. |
...
| AttackAssist guided attacks | Sandbox verification | [#87](https://github.com/Mord-Eagle/GameAssist/issues/87) | AttackAssist 1.0.3 adds authorized official-2014 repeating-attack selection, stable row identity, a compact native visible-target choice, retained private placement requests, executable explicit roll modes, documented optional-sheet defaults, a preflight refusal for unknown missing fields, one-use submission, and no damage or combat-state writes. |
| Guidance verified consumption | Sandbox verification | [#85](https://github.com/Mord-Eagle/GameAssist/issues/85) | EffectAssist 2.5.1 retains the compact owned Guidance label and may consume one exact, unambiguous supported 2014 skill check. Unsupported or ambiguous evidence remains manual; live normal/advantage/disadvantage acceptance is still required. |
