...
| AlmanacAssist custom-calendar and world-context completion | In progress | [#90](https://github.com/Mord-Eagle/GameAssist/issues/90), [#95](https://github.com/Mord-Eagle/GameAssist/issues/95) | AlmanacAssist 1.8.0 on the `AlmanacAssist-v2.0.0-Build` line retains the Issue #89 action-first checkpoint, accepts the Gate 0 repairs, and adds the read-only SceneResolver plus bounded generic Worldbuilding place composition, active Location, favorites/recents, and compact Current World dashboard. v2.0.0 still requires full live verification, prepared destinations/reviewed Travel/phenomena/presets, portable WorldPacks, temporal contexts, and the complete Issue #90 acceptance track. |
