...
| AlmanacAssist v2.0.0 custom-calendar and world-context completion | In progress | [#90](https://github.com/Mord-Eagle/GameAssist/issues/90), [#95](https://github.com/Mord-Eagle/GameAssist/issues/95), [#96](https://github.com/Mord-Eagle/GameAssist/issues/96) | AlmanacAssist **v2.0.0** on the `AlmanacAssist-v2.0.0-Build` line retains the Issue #89 action-first checkpoint and Gate 0 repairs, then builds the read-only SceneResolver, bounded generic Worldbuilding place composition, active Location/favorites/recents, Location-bound Prepared Destinations, reviewed route/pace Travel, explicit reviewed Phenomena overlays, and generic PresetRegistry campaign clones. RulesAdvisor, portable WorldPacks, and temporal contexts remain code work. Live Roll20 validation and the Issue #90 acceptance track are deferred until the full Issue #96 code build is complete. |
