...
13. **HealthService will normalize HP once.** Concentration prompts, healing, PC health alerts, and CombatAssist review timelines must consume one provenance-aware health contract rather than installing separate competing HP watchers. Missing HealthService disables only the optional integration that declared it.
...
| HealthService foundation | Recommended next foundation | [#83](https://github.com/Mord-Eagle/GameAssist/issues/83) | Normalize supported 2014 PC and linked-NPC HP transitions, deduplicate logical writes, and publish provenance-aware semantic events without owning concentration, death history, combat, or healing rules. |
| Concentration offers after HP loss | Blocked by #83 | [#79](https://github.com/Mord-Eagle/GameAssist/issues/79) | Whisper one damage/DC offer through ConcentrationAssist after a trustworthy HealthService event; manual checks remain complete. |
...
| Guidance one-use consumption | Evidence-gated | [#85](https://github.com/Mord-Eagle/GameAssist/issues/85) | Consume only an EffectAssist-owned Guidance instance proven by supported 2014 roll evidence; arbitrary d4 rolls remain untouched. |
| HealAssist | Deferred consumer | [#84](https://github.com/Mord-Eagle/GameAssist/issues/84) | Add guided 2014 healing only after HealthService provides verified HP reads, writes, provenance, and deduplication. |
| PC health alerts | Deferred consumer | [#86](https://github.com/Mord-Eagle/GameAssist/issues/86) | Add configurable GM-private threshold crossings through HealthService without duplicating NPCAssist Bloodied notices. |
| AttackAssist | Deferred new module | [#87](https://github.com/Mord-Eagle/GameAssist/issues/87) | Add guided 2014 attack selection and native targeting without replacing sheet attacks or applying damage automatically. |
...
- [x] Add player casting from controlled sources, native visible-recipient targeting, compact GM placement requests, verified public cast announcements, direct spell shortcuts, and GM lockout.
...
### Phase E — HealthService and HP-Loss Offers

**Tracking:** [Issue #83](https://github.com/Mord-Eagle/GameAssist/issues/83), then [Issue #79](https://github.com/Mord-Eagle/GameAssist/issues/79)
**Status:** Planned

Introduce one provenance-aware HealthService contract so supported damage can be distinguished from healing, token setup, HPAssist initialization, synchronization, and unknown writes. After that contract passes independently, ConcentrationAssist may offer one private damage/DC check without making EffectAssist or ConcentrationAssist another HP watcher.
...
## Recommended Bridge After `v2.0.0`

Keep this bridge deliberately narrow before beginning the full AlmanacAssist program:

1. Implement [#83 HealthService](https://github.com/Mord-Eagle/GameAssist/issues/83) as an independently testable observation and verified-write contract.
2. Implement [#79 concentration offers](https://github.com/Mord-Eagle/GameAssist/issues/79) as the first small consumer and prove the service against real Roll20 HP changes.
3. Begin AlmanacAssist with [#66 TimeAlmanac](https://github.com/Mord-Eagle/GameAssist/issues/66).

HealAssist [#84](https://github.com/Mord-Eagle/GameAssist/issues/84), PC health alerts [#86](https://github.com/Mord-Eagle/GameAssist/issues/86), and the CombatAssist damage timeline [#52](https://github.com/Mord-Eagle/GameAssist/issues/52) should wait for #83 rather than introducing their own HP listeners. Guidance consumption [#85](https://github.com/Mord-Eagle/GameAssist/issues/85) may proceed independently after representative 2014 roll evidence is captured. AttackAssist [#87](https://github.com/Mord-Eagle/GameAssist/issues/87) is valuable but does not block EffectAssist or AlmanacAssist and should remain a separate later module.
...
- deferred CombatAssist read-only damage-change history for guided retcon review, tracked in [Issue #52](https://github.com/Mord-Eagle/GameAssist/issues/52) and blocked by HealthService [#83](https://github.com/Mord-Eagle/GameAssist/issues/83);
- guided 2014 healing [#84](https://github.com/Mord-Eagle/GameAssist/issues/84) and PC health alerts [#86](https://github.com/Mord-Eagle/GameAssist/issues/86), both blocked by HealthService;
- verified one-use Guidance consumption [#85](https://github.com/Mord-Eagle/GameAssist/issues/85), gated by representative 2014 roll evidence;
- guided 2014 attack selection and targeting [#87](https://github.com/Mord-Eagle/GameAssist/issues/87), kept separate from native sheet attacks and automatic damage;
