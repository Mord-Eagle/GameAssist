...
| AlmanacAssist custom-calendar and world-context completion | In progress | [#90](https://github.com/Mord-Eagle/GameAssist/issues/90), [#95](https://github.com/Mord-Eagle/GameAssist/issues/95) | AlmanacAssist 1.7.0 on the `AlmanacAssist-v2.0.0-Build` line retains the Issue #89 action-first control checkpoint, accepts the Gate 0 repairs from Issues #92/#93, and adds a read-only SceneResolver foundation plus a compact Current World dashboard. v2.0.0 still requires full live verification, prepared places/travel/phenomena/presets, portable WorldPacks, temporal contexts, and the complete Issue #90 acceptance track. |
