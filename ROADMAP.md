...
| AlmanacAssist custom-calendar and world-context completion | In progress | [#90](https://github.com/Mord-Eagle/GameAssist/issues/90), [#95](https://github.com/Mord-Eagle/GameAssist/issues/95) | AlmanacAssist 1.9.0 on the `AlmanacAssist-v2.0.0-Build` line retains the Issue #89 action-first checkpoint and Gate 0 repairs, then adds the read-only SceneResolver, bounded generic Worldbuilding place composition, active Location/favorites/recents, Location-bound Prepared Destinations, and reviewed route/pace Travel. v2.0.0 still requires full live verification, phenomena/presets, portable WorldPacks, temporal contexts, and the complete Issue #90 acceptance track. |
