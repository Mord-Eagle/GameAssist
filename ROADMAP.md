...
| TokenAssist marker-expression parity | **Implemented; safe expression subset** | [#42](https://github.com/Mord-Eagle/GameAssist/issues/42) | MarkerService 1.1.0 implements the supported TokenMod 0.8.88 expression behavior for duplicate indexes, conditional operations, relative counts, bounds, relative colors, dimming, and relative/random side selection. Persistent asset writes remain separate. |
...
| CombatAssist damage timeline | **Implemented; bounded evidence** | [#52](https://github.com/Mord-Eagle/GameAssist/issues/52) | CombatAssist retains bounded HealthService changes with encounter, round, turn, actor, boundary, and provenance fields. It is explicitly evidence for review, not a causal damage ledger. |
