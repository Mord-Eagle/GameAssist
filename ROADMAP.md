...
| AlmanacAssist master program | Automated gates passed; live acceptance pending | [#95](https://github.com/Mord-Eagle/GameAssist/issues/95), [PR #81](https://github.com/Mord-Eagle/GameAssist/pull/81) | AlmanacAssist 2.0.1 completes the campaign-scale GM palettes and reviewed mileage-travel layer on the consolidated engine and all six internal systems; publication waits for the complete documented Roll20 acceptance track. |
...
| AlmanacAssist coherent world engine | Automated gates passed; live acceptance pending | [#95](https://github.com/Mord-Eagle/GameAssist/issues/95) | AlmanacAssist 2.0.1 adds compact weather/time/travel/event/announcement/setup palettes and stale-safe mileage travel with advisory road conditions and GM-private encounter checks while retaining Session and Worldbuilding modes, signed Year 0 chronology, a provenance-bearing SceneResolver, bounded definitions, prepared destinations, phenomena, local temporal contexts, presets, RulesAdvisor, advanced Wayfarer editing, and atomic WorldPacks. The focused local gate passes 157 checks; live Roll20 evidence is still outstanding. |
