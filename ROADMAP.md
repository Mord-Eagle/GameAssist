...
Use this document for durable release boundaries, sequencing, and completion gates. Use the linked GitHub issues for implementation details and acceptance evidence. Issues #60, #64, and #65 are complete. PR #81 remains the single v2.0.0 development line: EffectAssist, HealAssist, AttackAssist, and AlmanacAssist share that branch; Issue #88 carries the EffectAssist player-casting and retained GM-request workflow; and Issue #95 now governs AlmanacAssist 2.0.0 as the consolidated world-engine specification. Its focused 141-check non-live gate passes for Session/Worldbuilding modes, SceneResolver, Year 0 compatibility, world definitions, travel, temporal contexts, phenomena, presets, Wayfarer handout transactions, WorldPacks, and lifecycle preservation. Complete Roll20 live acceptance remains required and publication is not authorized by local evidence alone. Issue #91 defines the post-v2 shared character-sheet capability contract and phased 2024 adapters; Issues #83, #79, #80, #77, #84, and #87 retain their accepted v2.0.0 integration scope. None of this work creates a parallel release branch.
...
| AlmanacAssist master program | Automated gates passed; live acceptance pending | [#95](https://github.com/Mord-Eagle/GameAssist/issues/95), [PR #81](https://github.com/Mord-Eagle/GameAssist/pull/81) | AlmanacAssist 2.0.0 implements the consolidated campaign-world engine and all six internal systems on the one v2.0.0 branch; publication waits for the complete documented Roll20 acceptance track. |
...
| AlmanacAssist coherent world engine | Automated gates passed; live acceptance pending | [#95](https://github.com/Mord-Eagle/GameAssist/issues/95) | AlmanacAssist 2.0.0 adds Session and Worldbuilding modes, signed Year 0 chronology, a provenance-bearing SceneResolver, bounded world definitions, prepared destinations, reviewed travel, phenomena, local temporal contexts, immutable presets, read-only RulesAdvisor guidance, advanced Wayfarer handout editing, and atomic WorldPacks. The focused local gate passes 141 checks; live Roll20 evidence is still outstanding. |
...
| HealAssist guided healing | Sandbox verification | [#84](https://github.com/Mord-Eagle/GameAssist/issues/84) | HealAssist 1.2.1 adds authorized sources, direct targeting for one-recipient actions, count choices for multi-recipient actions, supported 2014 normal and maximum healing, default review or optional automatic verified application, private GM placement requests, safe public-result fallback, and HealthService writes without consuming resources. |
...
v2.0.0 does not publish until every internal system and Issue #95 world-engine workflow passes the focused Roll20 smoke track, GM-private PC threshold behavior passes Issue #86, guided HealAssist review and verified application passes Issue #84, guided AttackAssist source/target/roll/privacy behavior passes Issue #87, independent disable/re-enable and restart preservation are confirmed, RestAlmanac's supported 2014-sheet writes are proven with disposable characters, and PR #81 review is complete. Passing the 141-check local Almanac gate, TimeAlmanac alone, or any smaller subset is not a release candidate.
...
1. **Issue #95 - AlmanacAssist 2.0 coherent world engine:** the non-live implementation and focused 141-check gate are complete on PR #81. Next, run the documented Roll20 acceptance track for Session Mode, Worldbuilding Mode, coherent scenes, Year 0, travel, local time, phenomena, Wayfarer handout editing, WorldPacks, all six subsystem boundaries, rest writes, restart preservation, and UI readability before publication.
