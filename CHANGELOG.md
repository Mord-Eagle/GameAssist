...
- Builds the Issue #96 code program in order, currently including the generic immutable PresetRegistry, editable campaign Session Preset clones, and optional profile-specific advisory-only RulesAdvisor alongside the previously implemented SceneResolver, Worldbuilding, Travel, and Phenomena foundations.
