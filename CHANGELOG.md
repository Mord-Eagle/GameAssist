...
- MECHSUITS structural validation finds 29 correctly nested and paired sections, exact file-scoped canonical-tree agreement, matching section metadata, and required footers. This structural check does not by itself claim complete v1.5.2 compliance.
...
- Release acceptance includes the clean-install and v1.8.2 upgrade tracks in `Smoketest.md`, the focused EffectAssist checks, and the complete six-system AlmanacAssist track in the live Roll20 Mod sandbox.
