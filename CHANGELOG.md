...
| --- | --- | --- |
| **v2.0.0** | Active development in PR #81; focused EffectAssist, AlmanacAssist, and HealthService checks passed; Roll20 acceptance pending | Source-aware effects, complete campaign-world systems, and canonical HP evidence |
