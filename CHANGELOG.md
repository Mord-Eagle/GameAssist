...
- Separates the Campaign Clock from a distinct WorldPack local clock in Session Mode without creating a second time authority. Time, Rest, and Travel make clear that quick anchors and reviewed duration changes operate on the Campaign Clock; setting-plus-current-area context now stays visible through Change Location, primary Travel, Phenomena, and private announcement-preview cards.
