...
📜 3  Create 7 roll-tables (see §11: Roll-Table Cookbook)
...
| Fresh sandbox (runs 25–34) |    10   | **355 ms** | 350 ms | 18 ms     | 330 – 387 ms |
...
* **No debug output for a module**
  To enable compatibility logs for conflicting scripts, open the API Console and enter:
