...
- player casting requires control of the source, uses Roll20's map target prompt for visible recipients without requiring recipient control, announces a verified completed cast publicly, offers a compact GM-request fallback, and obeys the GM lockout without exposing GM-only menus;
