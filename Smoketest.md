...
> This guide tests GameAssist v2.0.0. It covers the accepted 2014-sheet EffectAssist foundation, the complete AlmanacAssist release track, and the shared HealthService foundation while retaining the established component checks and the v1.8.2 NPCAssist naming and Bloodied regressions.
